...
namespace Funemag.Controllers
{
    public class PlatformsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlatformId,Maker,Name")] Platform platform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlatformId,Maker,Name")] Platform platform)
        {
            if (ModelState.IsValid)
            {
